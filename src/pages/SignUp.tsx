...
const SignUp = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast({
        ...
        description: "Welcome to RealtyHub! Your account has been created successfully."
      });
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-slate-50 dark:from-gray-900 dark:via-gray-800 dark:to-slate-900">
      {/* Navigation */}
      <nav className="bg-card/80 backdrop-blur-md shadow-sm border-b">
      ...
      <div className="flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
        <Card className="w-full max-w-md animate-scale-in">
          <CardHeader className="text-center">
            ...
            <p className="text-muted-foreground">Join RealtyHub to find your dream property</p>
          </CardHeader>
